...
* Студент: [Евгений Чиликов](https://up.htmlacademy.ru/htmlcss/29/user/615575).
* Наставник: `Чайник`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/615575-technomart-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
